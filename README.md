...
[ ![Download](https://api.bintray.com/packages/tonyofrancis/maven/fetch2/images/download.svg?version=3.0.2) ](https://bintray.com/tonyofrancis/maven/fetch2/3.0.2/link)
...
```java
implementation "com.tonyodev.fetch2rx:fetch2rx:3.0.2"
```
...
```java
implementation "com.tonyodev.fetch2fileserver:fetch2fileserver:3.0.2"
```
...
```java
implementation "com.tonyodev.fetchmigrator:fetchmigrator:3.0.2"
```
