...
[ ![Download](https://api.bintray.com/packages/tonyofrancis/maven/fetch2/images/download.svg?version=3.0.6) ](https://bintray.com/tonyofrancis/maven/fetch2/3.0.6/link)
...
```java
implementation "com.tonyodev.fetch2:fetch2:3.0.6"
```
Androidx use:
```java
...
```java
implementation "com.tonyodev.fetch2okhttp:fetch2okhttp:3.0.6"
```
Androidx use:
```java
...
```java
implementation "com.tonyodev.fetch2rx:fetch2rx:3.0.6"
```
Androidx use:
```java
...
```java
implementation "com.tonyodev.fetch2fileserver:fetch2fileserver:3.0.6"
```
Androidx use: 
```java
...
```java
implementation "com.tonyodev.fetchmigrator:fetchmigrator:3.0.6"
```
Androidx use:
```java
