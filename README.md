...
[ ![Download](https://api.bintray.com/packages/tonyofrancis/maven/fetch2/images/download.svg?version=2.1.0-RC12) ](https://bintray.com/tonyofrancis/maven/fetch2/2.1.0-RC12/link)
...
```java
implementation "com.tonyodev.fetch2:fetch2:2.1.0-RC12"
```
...
```java
implementation "com.tonyodev.fetch2okhttp:fetch2okhttp:2.1.0-RC12"
```
...
```java
implementation "com.tonyodev.fetch2rx:fetch2rx:2.1.0-RC12"
```
...
```java
implementation "com.tonyodev.fetch2fileserver:fetch2fileserver:2.1.0-RC12"
```
...
```java
implementation "com.tonyodev.fetch2downloaders:fetch2downloaders:2.1.0-RC12"
```
...
```java
implementation "com.tonyodev.fetchmigrator:fetchmigrator:2.1.0-RC12"
```
