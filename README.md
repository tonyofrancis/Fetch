...
[ ![Download](https://api.bintray.com/packages/tonyofrancis/maven/fetch2/images/download.svg?version=2.0.0-RC13) ](https://bintray.com/tonyofrancis/maven/fetch2/2.0.0-RC13/link)
...
```java
implementation "com.tonyodev.fetch2:fetch2:2.0.0-RC13"
```
...
```java
implementation "com.tonyodev.fetch2downloaders:fetch2downloaders:2.0.0-RC13"
```
...
```java
implementation "com.tonyodev.fetch2rx:fetch2rx:2.0.0-RC13"
```
...
```java
implementation "com.tonyodev.fetchmigrator:fetchmigrator:2.0.0-RC13"
```
