...
[ ![Download](https://api.bintray.com/packages/tonyofrancis/maven/fetch2/images/download.svg?version=2.2.0-RC4) ](https://bintray.com/tonyofrancis/maven/fetch2/2.2.0-RC4/link)
...
```java
implementation "com.tonyodev.fetch2:fetch2:2.2.0-RC4"
```
...
```java
implementation "com.tonyodev.fetch2okhttp:fetch2okhttp:2.2.0-RC4"
```
...
```java
implementation "com.tonyodev.fetch2fileserver:fetch2fileserver:2.2.0-RC4"
```
...
```java
implementation "com.tonyodev.fetchmigrator:fetchmigrator:2.2.0-RC4"
```
