...
[ ![Download](https://api.bintray.com/packages/tonyofrancis/maven/fetch2/images/download.svg?version=2.3.1) ](https://bintray.com/tonyofrancis/maven/fetch2/2.3.1/link)
...
```java
implementation "com.tonyodev.fetch2rx:fetch2rx:2.3.1"
```
...
```java
implementation "com.tonyodev.fetch2fileserver:fetch2fileserver:2.3.1"
```
...
```java
implementation "com.tonyodev.fetchmigrator:fetchmigrator:2.3.1"
```
