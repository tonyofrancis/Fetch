...
[ ![Download](https://api.bintray.com/packages/tonyofrancis/maven/fetch2/images/download.svg?version=2.2.0-RC3) ](https://bintray.com/tonyofrancis/maven/fetch2/2.2.0-RC3/link)
...
```java
implementation "com.tonyodev.fetch2rx:fetch2rx:2.2.0-RC3"
```
...
```java
implementation "com.tonyodev.fetch2fileserver:fetch2fileserver:2.2.0-RC3"
```
...
```java
implementation "com.tonyodev.fetchmigrator:fetchmigrator:2.2.0-RC3"
```
